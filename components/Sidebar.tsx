...
export const Sidebar = ({
  ...
  return (
    <>
      ...
      <div
        className={`w-48 flex flex-col h-screen fixed left-0 top-0 z-30 transition-transform duration-300 ease-in-out bg-slate-900 border-r border-white/10 shadow-[4px_0_24px_rgba(0,0,0,0.4)] ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}
      >
