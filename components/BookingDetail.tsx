            ...
            <div>
              ...
              <div className="space-y-2">
                {draft.spaces.length === 0 && (
                  <p className="text-sm text-slate-400 italic">No spaces yet — add at least one.</p>
                )}
                  ...
                  >
                    ...
                    <div className="col-span-5 md:col-span-1">
                      ...
                      <input
                        ...
                        onChange={(e) => updateSpace(space.key, { setup_minutes: e.target.value })}
                        className={inputClass}
                    ...
                    <div className="mt-2 space-y-2">
                      {conflicts.every(
                        ...
                        <div className="flex items-center gap-1.5 text-sm text-emerald-700 bg-emerald-50 border border-emerald-200 rounded-lg px-3 py-2">
                          <CheckCircle2 size={15} /> All spaces are free — no overlapping bookings.
                        </div>
                      ) : (
