      ...
      <div className="bg-white border border-slate-200 rounded-lg p-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-white border border-slate-300 rounded-lg text-sm text-slate-900 placeholder-slate-400 focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500 outline-none"
                />
        ...
        <div className="mt-6 pt-6 border-t border-slate-200 flex justify-end gap-3">
          <button
            ...
            disabled={loading}
            className="px-4 py-2 text-slate-700 bg-white border border-slate-300 rounded-lg text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancel
          </button>
          <button
