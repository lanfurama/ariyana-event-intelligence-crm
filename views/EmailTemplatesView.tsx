                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className={`px-3 py-1 text-xs font-medium rounded transition-colors ${bodyViewMode === 'code'
                    ...
                    <button
                      ...
                      className={`px-3 py-1 text-xs font-medium rounded transition-colors ${bodyViewMode === 'preview'
                        ? 'bg-indigo-600 text-white'
                        : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
                        }`}
                    >
